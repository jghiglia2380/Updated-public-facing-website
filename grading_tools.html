...
<head>
    ...
    <title>Explore Grading Tools - PFL Academy</title>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      <div class="flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-8">
          ...
          <a href="/static-build/dashboard.html" class="text-gray-700 font-medium hover:text-indigo-600 text-sm">Instructor Dashboard</a>
  ...
  <div class="h-20"></div>
    ...
    <section class="bg-indigo-600 text-white py-16 px-4">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl font-bold mb-4">Explore Grading Tools</h1>
            <p class="text-xl mb-8 max-w-2xl mx-auto">
                Discover the tools that make grading simple, customizable, and seamless.
            </p>
            <a 
                href="/static-build/dashboard.html"
                class="bg-white text-indigo-600 px-6 py-3 rounded-lg font-medium shadow-lg hover:bg-indigo-50 transition-colors"
            >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative features-grid" id="features-grid">
                ...
                <div class="feature-card bg-white rounded-xl shadow-md overflow-hidden cursor-pointer" data-feature="auto-graded">
                    ...
                    <div class="popout-content bg-white rounded-xl shadow-xl p-6 animate-fadeIn">
                        ...
                        <div class="mt-4 text-center">
                            <a href="/static-build/auto_grading.html" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-sm">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card bg-white rounded-xl shadow-md overflow-hidden cursor-pointer" data-feature="custom-rubrics">
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-semibold text-center mb-2">Custom Rubrics & Weighting</h3>
                        <p class="text-gray-600 text-center">Define custom grading rubrics and set category weights for assignments</p>
                    </div>
                    ...
                    <div class="popout-content bg-white rounded-xl shadow-xl p-6 animate-fadeIn">
                        ...
                        <div class="mt-4 text-center">
                            <a href="/static-build/rubric_editor.html" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-sm">Learn More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card bg-white rounded-xl shadow-md overflow-hidden cursor-pointer" data-feature="lms-sync">
                    ...
                    <div class="popout-content bg-white rounded-xl shadow-xl p-6 animate-fadeIn">
                        ...
                        <div class="mt-4 text-center">
                            <a href="/static-build/lms_integration.html" class="inline-block px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-sm">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 px-4 bg-gray-100">
        <div class="max-w-6xl mx-auto">
            <h2 class="text-3xl font-bold text-center mb-8 text-gray-800">See It in Action</h2>
            <p class="text-xl mb-12 text-gray-600 text-center max-w-2xl mx-auto">
                Experience how the Instructor Dashboard puts these tools to work for easy grading management.
            </p>
            
            <div class="dashboard-preview max-w-4xl mx-auto">
                <img src="https://via.placeholder.com/1200x800/f3f4f6/4f46e5?text=Dashboard+Screenshot" alt="Instructor Dashboard" class="dashboard-image w-full">
                <div class="preview-overlay">
                    <h3 class="text-2xl font-bold text-white mb-4 text-center">Instructor Dashboard</h3>
                    <p class="text-white text-lg mb-8 text-center max-w-lg px-4">
                        Track student progress, enter grades, and customize grading preferences all in one place.
                    </p>
                    <a href="/static-build/dashboard.html" class="bg-white text-indigo-600 px-6 py-3 rounded-lg font-medium shadow-lg hover:bg-gray-100 transition-colors inline-block">
                        Open Dashboard
                    </a>
                </div>
            </div>
          ...
          <div class="grid grid-cols-2 gap-8 xl:col-span-3 xl:grid-cols-3">
            ...
            <div>
              ...
              <ul class="mt-4 space-y-3">
                ...
                <li>
                  <a href="/static-build/dashboard.html" class="text-sm text-gray-600 hover:text-indigo-600">
